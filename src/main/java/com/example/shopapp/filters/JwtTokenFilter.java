...
//				filterChain.doFilter(request, response); //enable bypass (cho qua hết)lọc
//				return;
//			}
//			
//			final String authHeader = request.getHeader("Authorization");// truyền kiểu dữ liễu 
//			
...
//				}
//			}
//			filterChain.doFilter(request, response); //enable bypass (cho qua hết)
//		} catch (Exception e) {
//			response.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Unauthorized");
//	}		
//}
...
//				);// những request ko cần token đại diện cho api
//		
