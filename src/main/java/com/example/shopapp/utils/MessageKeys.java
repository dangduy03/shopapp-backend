...
public class MessageKeys {
	...
	public static final String UPLOAD_IMAGES_MAX_5 = "product.upload_images.eror_max_5_image";
	
	public static final String UPLOAD_IMAGES_FILE_LARGE = "product.upload_images.files_lagre";
	
	public static final String  UPLOAD_IMAGES_FILE_MUST_BEE_IMAGE = "product.upload_images.file_mustt_be_image";
